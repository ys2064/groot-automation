...
python scripts/gr00t_finetune.py \
  ...
  --tune-visual \
  --output-dir "$OUT_DIR" \
  --data-config /rlwrld1/home/yashu/rlwrld_isaac/gr00t/configs/groot_Cube_Stack_3cmRight_100pct.yaml \
  --max-steps 30000 \
  --save-steps 10000 \
...
notify_training_complete('Cube_Stack_3cmRight', 100, '$OUT_DIR')
"
