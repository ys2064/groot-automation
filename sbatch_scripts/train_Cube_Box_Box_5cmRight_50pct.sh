...
# Define Output
OUT_DIR="/rlwrld1/home/yashu/output/train/Cube_Box_Box_5cmRight_50pct"
mkdir -p "$OUT_DIR"

# Launch Training
cd /rlwrld1/home/yashu/rlwrld_isaac/gr00t
python scripts/gr00t_finetune.py   --num-gpus 4   --batch-size 32   --learning_rate 1e-4   --tune-visual   --output-dir "$OUT_DIR"   --data-config /rlwrld1/home/yashu/rlwrld_isaac/gr00t/configs/groot_Cube_Box_Box_5cmRight_50pct.yaml   --max-steps 30000   --save-steps 10000   --dataloader-num-workers 8
