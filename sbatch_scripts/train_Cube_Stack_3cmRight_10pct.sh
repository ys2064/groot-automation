#!/bin/bash
#SBATCH --job-name=Cube_Stack_3cmRight_10pct
#SBATCH --output=/rlwrld1/home/yashu/rlwrld_isaac/gr00t/log/%j-Cube_Stack_3cmRight_10pct.out
#SBATCH --error=/rlwrld1/home/yashu/rlwrld_isaac/gr00t/log/%j-Cube_Stack_3cmRight_10pct.err
...
# Define Output
OUT_DIR="/rlwrld1/home/yashu/output/train/Cube_Stack_3cmRight_10pct"
mkdir -p "$OUT_DIR"
